...
class VerifyApplicationCannotSaveData : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        (findViewById(R.id.tv_name) as TextView).text = MyApplication.getInstance().name.toUpperCase()
        TestCompanion.create()
    }

    companion object TestCompanion {
        val TAG = "VerifyApplication"
        fun create() {
            Log.d(TAG, "companion object create")
        }
    }
}
